module.exports=[85148,(e,t,r)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},22734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},20635,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},59043,(e,t,r)=>{t.exports=e.x("next/dist/server/runtime-reacts.external.js",()=>require("next/dist/server/runtime-reacts.external.js"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},81111,(e,t,r)=>{t.exports=e.x("node:stream",()=>require("node:stream"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},42653,e=>{"use strict";var t=e.i(89171),r=e.i(62294),s=e.i(54799);async function T(e){let{visitorId:T,name:a,phone:n,email:i}=await e.json();if(!T)return t.NextResponse.json({error:"visitorId required"},{status:400});let o=(0,r.getDb)(),E=new Date().toISOString(),d=o.prepare("SELECT id FROM chat_sessions WHERE visitorId = ? AND status = 'open' ORDER BY createdAt DESC LIMIT 1").get(T);if(d)return(a||n||i)&&o.prepare("UPDATE chat_sessions SET name=COALESCE(?,name), phone=COALESCE(?,phone), email=COALESCE(?,email) WHERE id=?").run(a||null,n||null,i||null,d.id),t.NextResponse.json({sessionId:d.id});let L=(0,s.randomBytes)(8).toString("hex");return o.prepare(`
    INSERT INTO chat_sessions (id, visitorId, name, phone, email, status, unreadAdmin, lastMessageAt, createdAt)
    VALUES (?, ?, ?, ?, ?, 'open', 0, ?, ?)
  `).run(L,T,a||null,n||null,i||null,E,E),t.NextResponse.json({sessionId:L})}e.s(["POST",0,T])},21087,e=>{"use strict";var t=e.i(47909),r=e.i(74017),s=e.i(96250),T=e.i(59756),a=e.i(61916),n=e.i(74677),i=e.i(69741),o=e.i(16795),E=e.i(87718),d=e.i(95169),L=e.i(47587),N=e.i(66012),c=e.i(70101),l=e.i(26937),p=e.i(10372),u=e.i(93695);e.i(52474);var A=e.i(220);let U=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/chat/session/route",pathname:"/api/chat/session",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/chat/session/route.ts",nextConfigOutput:"",userland:()=>e.r(42653),...{}}),{workAsyncStorage:R,workUnitAsyncStorage:O,serverHooks:m}=U;async function X(e,t,s){s.requestMeta&&(0,T.setRequestMeta)(e,s.requestMeta),U.isDev&&(0,T.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let R="/api/chat/session/route";R=R.replace(/\/index$/,"")||"/";let O=await U.prepare(e,t,{srcPage:R,multiZoneDraftMode:!1});if(!O)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:m,deploymentId:X,params:_,nextConfig:I,parsedUrl:h,isDraftMode:x,prerenderManifest:v,routerServerContext:S,isOnDemandRevalidate:g,revalidateOnlyGenerated:C,resolvedPathname:D,clientReferenceManifest:f,serverActionsManifest:F}=O,y=(0,i.normalizeAppPath)(R),w=!!(v.dynamicRoutes[y]||v.routes[D]),M=async()=>((null==S?void 0:S.render404)?await S.render404(e,t,h,!1):t.end("This page could not be found"),null);if(w&&!x){let e=!!v.routes[D],t=v.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(I.adapterPath)return await M();throw new u.NoFallbackError}}let b=null;!w||U.isDev||x||(b="/index"===(b=D)?"/":b);let P=!0===U.isDev||!w,k=w&&!P;F&&f&&(0,n.setManifestsSingleton)({page:R,clientReferenceManifest:f,serverActionsManifest:F});let q=e.method||"GET",Y=(0,a.getTracer)(),B=Y.getActiveScopeSpan(),j=!!(null==S?void 0:S.isWrappedByNextServer),K=!!(0,T.getRequestMeta)(e,"minimalMode"),H=(0,T.getRequestMeta)(e,"incrementalCache")||await U.getIncrementalCache(e,I,v,K);null==H||H.resetRequestCache(),globalThis.__incrementalCache=H;let G={params:_,previewProps:v.preview,renderOpts:{experimental:{authInterrupts:!!I.experimental.authInterrupts,useCacheTimeout:I.experimental.useCacheTimeout},cacheComponents:!!I.cacheComponents,validationLevel:I.experimental.instantInsights.validationLevel,supportsDynamicResponse:P,incrementalCache:H,hmrRefreshHash:(0,T.getRequestMeta)(e,"hmrRefreshHash"),cacheLifeProfiles:I.cacheLife,staticPageGenerationTimeout:I.staticPageGenerationTimeout,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,s,T)=>U.onRequestError(e,t,s,T,S)},sharedContext:{buildId:m,deploymentId:X}},W=new o.NodeNextRequest(e),$=new o.NodeNextResponse(t),V=E.NextRequestAdapter.fromNodeNextRequest(W,(0,E.signalFromNodeResponse)(t)),Q=async({previousCacheEntry:r})=>{try{if(!K&&g&&C&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let T=await U.handle(V,G);e.fetchMetrics=G.renderOpts.fetchMetrics;let a=G.renderOpts.pendingWaitUntil;a&&s.waitUntil&&(s.waitUntil(a),a=void 0);let n=G.renderOpts.collectedTags;if(!w)return await (0,N.sendResponse)(W,$,T,a),null;{let e=await T.blob(),t=(0,c.toNodeOutgoingHttpHeaders)(T.headers);n&&(t[p.NEXT_CACHE_TAGS_HEADER]=n),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==G.renderOpts.collectedRevalidate&&!(G.renderOpts.collectedRevalidate>=p.INFINITE_CACHE)&&G.renderOpts.collectedRevalidate,s=void 0===G.renderOpts.collectedExpire||G.renderOpts.collectedExpire>=p.INFINITE_CACHE?!1!==r&&r>0?I.expireTime:void 0:G.renderOpts.collectedExpire;return{value:{kind:A.CachedRouteKind.APP_ROUTE,status:T.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:s}}}}catch(t){throw(null==r?void 0:r.isStale)&&await U.onRequestError(e,t,{routerKind:"App Router",routePath:R,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:g})},!1,S),t}},J=async(T,n)=>{try{var i,o;let T=await U.handleResponse({req:e,nextConfig:I,cacheKey:b,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:v,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:C,responseGenerator:Q,waitUntil:s.waitUntil,isMinimalMode:K});if(!w)return;if((null==T||null==(i=T.value)?void 0:i.kind)!==A.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==T||null==(o=T.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",g?"REVALIDATED":T.isMiss?"MISS":T.isStale?"STALE":"HIT"),x&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let a=(0,c.fromNodeOutgoingHttpHeaders)(T.value.headers);K&&w||a.delete(p.NEXT_CACHE_TAGS_HEADER),!T.cacheControl||t.getHeader("Cache-Control")||a.get("Cache-Control")||a.set("Cache-Control",(0,l.getCacheControlHeader)(T.cacheControl)),await (0,N.sendResponse)(W,$,new Response(T.value.body,{headers:a,status:T.value.status||200}));return}catch(t){if(t instanceof u.NoFallbackError||await U.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:g})},!1,S),w)throw t;await (0,N.sendResponse)(W,$,new Response(null,{status:500}));return}finally{(()=>{if(!T)return;let e=t.statusCode;T.setAttributes({"http.status_code":e,"next.rsc":!1}),e&&e>=500&&(T.setStatus({code:a.SpanStatusCode.ERROR}),T.setAttribute("error.type",e.toString()));let r=Y.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=r.get("next.route")||y,i=`${q} ${s}`;T.setAttributes({"next.route":s,"http.route":s,"next.span_name":i}),T.updateName(i),n&&n!==T&&(n.setAttribute("http.route",s),n.updateName(i))})()}};if(j&&B)await J(B,void 0);else{let t=Y.getActiveScopeSpan();await Y.withPropagatedContext(e.headers,()=>Y.trace(d.BaseServerSpan.handleRequest,{spanName:`${q} ${R}`,kind:a.SpanKind.SERVER,attributes:{"http.method":q,"http.target":e.url}},e=>J(e,t)),void 0,!j)}}e.s(["handler",0,X,"patchFetch",0,function(){return(0,s.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:O})},"routeModule",0,U,"serverHooks",0,m,"workAsyncStorage",0,R,"workUnitAsyncStorage",0,O])},62294,e=>{"use strict";var t=e.i(85148),r=e.i(14747),s=e.i(22734);let T=process.env.DATA_DIR??r.default.join(process.cwd(),"data"),a=r.default.join(T,"bevans.db"),n=null;function i(){var e;let r;return n||((0,s.existsSync)(T)||(0,s.mkdirSync)(T,{recursive:!0}),(n=new t.default(a)).pragma("journal_mode = WAL"),n.pragma("foreign_keys = ON"),(e=n).exec(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f6xypq._.js.map