module.exports=[25710,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/app/admin/dashboard/ProductForm.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/app/admin/dashboard/ProductForm.tsx","default")},89596,a=>{"use strict";var b=a.i(25710);a.n(b)},31301,a=>{"use strict";var b=a.i(7997),c=a.i(19419);a.i(70396);var d=a.i(73727),e=a.i(95936),f=a.i(89596);async function g({params:a}){let{id:h}=await a,i=(0,c.getProduct)(h);return i||(0,d.notFound)(),(0,b.jsxs)("div",{className:"min-h-screen bg-[#0A0A0A]",children:[(0,b.jsxs)("header",{className:"bg-[#0f0f0f] border-b border-[#1A1A1A] px-4 sm:px-6 py-3 flex items-center gap-3",children:[(0,b.jsx)(e.default,{href:"/admin/dashboard",className:"text-gray-500 hover:text-white text-sm transition-colors shrink-0",children:"← Dashboard"}),(0,b.jsx)("span",{className:"text-gray-700",children:"/"}),(0,b.jsx)("h1",{className:"text-white font-semibold text-sm truncate",children:"Edit Product"})]}),(0,b.jsxs)("div",{className:"max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10",children:[(0,b.jsxs)("div",{className:"mb-6",children:[(0,b.jsx)("h2",{className:"text-xl sm:text-2xl font-bold text-white mb-1",children:"Edit Product"}),(0,b.jsx)("p",{className:"text-gray-500 text-sm",children:"Update the details below. Changes are saved immediately."})]}),(0,b.jsx)("div",{className:"bg-[#111111] border border-[#1F1F1F] rounded-2xl p-4 sm:p-8",children:(0,b.jsx)(f.default,{product:i})})]})]})}a.s(["default",0,g])},99516,function(a){a.n(a.i(31301))},66879,a=>{"use strict";var b=a.i(85148),c=a.i(14747),d=a.i(22734);let e=process.env.DATA_DIR??c.default.join(process.cwd(),"data"),f=c.default.join(e,"bevans.db"),g=null;a.s(["getDb",0,function(){var a;let c;return g||((0,d.existsSync)(e)||(0,d.mkdirSync)(e,{recursive:!0}),(g=new b.default(f)).pragma("journal_mode = WAL"),g.pragma("foreign_keys = ON"),(a=g).exec(`
...
//# sourceMappingURL=_1yz3mcg._.js.map