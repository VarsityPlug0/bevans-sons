module.exports=[85148,(e,t,r)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},22734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},20635,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},59043,(e,t,r)=>{t.exports=e.x("next/dist/server/runtime-reacts.external.js",()=>require("next/dist/server/runtime-reacts.external.js"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},81111,(e,t,r)=>{t.exports=e.x("node:stream",()=>require("node:stream"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},89876,e=>{"use strict";var t=e.i(89171),r=e.i(68105),s=e.i(62294);async function a(){if(!await (0,r.isAuthenticated)())return t.NextResponse.json({error:"Unauthorized"},{status:401});let e=(0,s.getDb)().prepare("SELECT * FROM categories ORDER BY gender, position, name").all();return t.NextResponse.json(e)}async function T(e){if(!await (0,r.isAuthenticated)())return t.NextResponse.json({error:"Unauthorized"},{status:401});let{name:a,gender:T}=await e.json();if(!a?.trim())return t.NextResponse.json({error:"name is required"},{status:400});let n=(0,s.getDb)(),i=a.trim().toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),o=n.prepare("SELECT MAX(position) as m FROM categories WHERE gender = ?").get(T??"Unisex").m??-1;try{n.prepare("INSERT INTO categories (id, name, gender, position, createdAt) VALUES (?, ?, ?, ?, ?)").run(i,a.trim(),T??"Unisex",o+1,new Date().toISOString())}catch{return t.NextResponse.json({error:"Category already exists"},{status:409})}return t.NextResponse.json({id:i,name:a.trim(),gender:T??"Unisex"},{status:201})}e.s(["GET",0,a,"POST",0,T])},27314,e=>{"use strict";var t=e.i(47909),r=e.i(74017),s=e.i(96250),a=e.i(59756),T=e.i(61916),n=e.i(74677),i=e.i(69741),o=e.i(16795),E=e.i(87718),d=e.i(95169),L=e.i(47587),c=e.i(66012),N=e.i(70101),p=e.i(26937),u=e.i(10372),l=e.i(93695);e.i(52474);var A=e.i(220);let U=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/admin/categories/route",pathname:"/api/admin/categories",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/admin/categories/route.ts",nextConfigOutput:"",userland:()=>e.r(89876),...{}}),{workAsyncStorage:R,workUnitAsyncStorage:O,serverHooks:m}=U;async function X(e,t,s){s.requestMeta&&(0,a.setRequestMeta)(e,s.requestMeta),U.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let R="/api/admin/categories/route";R=R.replace(/\/index$/,"")||"/";let O=await U.prepare(e,t,{srcPage:R,multiZoneDraftMode:!1});if(!O)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:m,deploymentId:X,params:x,nextConfig:_,parsedUrl:g,isDraftMode:h,prerenderManifest:I,routerServerContext:v,isOnDemandRevalidate:S,revalidateOnlyGenerated:C,resolvedPathname:D,clientReferenceManifest:f,serverActionsManifest:F}=O,y=(0,i.normalizeAppPath)(R),w=!!(I.dynamicRoutes[y]||I.routes[D]),M=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,g,!1):t.end("This page could not be found"),null);if(w&&!h){let e=!!I.routes[D],t=I.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(_.adapterPath)return await M();throw new l.NoFallbackError}}let b=null;!w||U.isDev||h||(b="/index"===(b=D)?"/":b);let P=!0===U.isDev||!w,k=w&&!P;F&&f&&(0,n.setManifestsSingleton)({page:R,clientReferenceManifest:f,serverActionsManifest:F});let q=e.method||"GET",Y=(0,T.getTracer)(),j=Y.getActiveScopeSpan(),B=!!(null==v?void 0:v.isWrappedByNextServer),K=!!(0,a.getRequestMeta)(e,"minimalMode"),H=(0,a.getRequestMeta)(e,"incrementalCache")||await U.getIncrementalCache(e,_,I,K);null==H||H.resetRequestCache(),globalThis.__incrementalCache=H;let G={params:x,previewProps:I.preview,renderOpts:{experimental:{authInterrupts:!!_.experimental.authInterrupts,useCacheTimeout:_.experimental.useCacheTimeout},cacheComponents:!!_.cacheComponents,validationLevel:_.experimental.instantInsights.validationLevel,supportsDynamicResponse:P,incrementalCache:H,hmrRefreshHash:(0,a.getRequestMeta)(e,"hmrRefreshHash"),cacheLifeProfiles:_.cacheLife,staticPageGenerationTimeout:_.staticPageGenerationTimeout,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,s,a)=>U.onRequestError(e,t,s,a,v)},sharedContext:{buildId:m,deploymentId:X}},W=new o.NodeNextRequest(e),$=new o.NodeNextResponse(t),V=E.NextRequestAdapter.fromNodeNextRequest(W,(0,E.signalFromNodeResponse)(t)),z=async({previousCacheEntry:r})=>{try{if(!K&&S&&C&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await U.handle(V,G);e.fetchMetrics=G.renderOpts.fetchMetrics;let T=G.renderOpts.pendingWaitUntil;T&&s.waitUntil&&(s.waitUntil(T),T=void 0);let n=G.renderOpts.collectedTags;if(!w)return await (0,c.sendResponse)(W,$,a,T),null;{let e=await a.blob(),t=(0,N.toNodeOutgoingHttpHeaders)(a.headers);n&&(t[u.NEXT_CACHE_TAGS_HEADER]=n),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==G.renderOpts.collectedRevalidate&&!(G.renderOpts.collectedRevalidate>=u.INFINITE_CACHE)&&G.renderOpts.collectedRevalidate,s=void 0===G.renderOpts.collectedExpire||G.renderOpts.collectedExpire>=u.INFINITE_CACHE?!1!==r&&r>0?_.expireTime:void 0:G.renderOpts.collectedExpire;return{value:{kind:A.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:s}}}}catch(t){throw(null==r?void 0:r.isStale)&&await U.onRequestError(e,t,{routerKind:"App Router",routePath:R,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:S})},!1,v),t}},Q=async(a,n)=>{try{var i,o;let a=await U.handleResponse({req:e,nextConfig:_,cacheKey:b,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:S,revalidateOnlyGenerated:C,responseGenerator:z,waitUntil:s.waitUntil,isMinimalMode:K});if(!w)return;if((null==a||null==(i=a.value)?void 0:i.kind)!==A.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==a||null==(o=a.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",S?"REVALIDATED":a.isMiss?"MISS":a.isStale?"STALE":"HIT"),h&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let T=(0,N.fromNodeOutgoingHttpHeaders)(a.value.headers);K&&w||T.delete(u.NEXT_CACHE_TAGS_HEADER),!a.cacheControl||t.getHeader("Cache-Control")||T.get("Cache-Control")||T.set("Cache-Control",(0,p.getCacheControlHeader)(a.cacheControl)),await (0,c.sendResponse)(W,$,new Response(a.value.body,{headers:T,status:a.value.status||200}));return}catch(t){if(t instanceof l.NoFallbackError||await U.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,L.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:S})},!1,v),w)throw t;await (0,c.sendResponse)(W,$,new Response(null,{status:500}));return}finally{(()=>{if(!a)return;let e=t.statusCode;a.setAttributes({"http.status_code":e,"next.rsc":!1}),e&&e>=500&&(a.setStatus({code:T.SpanStatusCode.ERROR}),a.setAttribute("error.type",e.toString()));let r=Y.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=r.get("next.route")||y,i=`${q} ${s}`;a.setAttributes({"next.route":s,"http.route":s,"next.span_name":i}),a.updateName(i),n&&n!==a&&(n.setAttribute("http.route",s),n.updateName(i))})()}};if(B&&j)await Q(j,void 0);else{let t=Y.getActiveScopeSpan();await Y.withPropagatedContext(e.headers,()=>Y.trace(d.BaseServerSpan.handleRequest,{spanName:`${q} ${R}`,kind:T.SpanKind.SERVER,attributes:{"http.method":q,"http.target":e.url}},e=>Q(e,t)),void 0,!B)}}e.s(["handler",0,X,"patchFetch",0,function(){return(0,s.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:O})},"routeModule",0,U,"serverHooks",0,m,"workAsyncStorage",0,R,"workUnitAsyncStorage",0,O])},62294,e=>{"use strict";var t=e.i(85148),r=e.i(14747),s=e.i(22734);let a=process.env.DATA_DIR??r.default.join(process.cwd(),"data"),T=r.default.join(a,"bevans.db"),n=null;function i(){var e;let r;return n||((0,s.existsSync)(a)||(0,s.mkdirSync)(a,{recursive:!0}),(n=new t.default(T)).pragma("journal_mode = WAL"),n.pragma("foreign_keys = ON"),(e=n).exec(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c_p8wn._.js.map