module.exports=[62294,e=>{"use strict";var s=e.i(85148),t=e.i(14747),i=e.i(22734);let o=process.env.DATA_DIR??t.default.join(process.cwd(),"data"),T=t.default.join(o,"bevans.db"),r=null;function a(){var e;let t;return r||((0,i.existsSync)(o)||(0,i.mkdirSync)(o,{recursive:!0}),(r=new s.default(T)).pragma("journal_mode = WAL"),r.pragma("foreign_keys = ON"),(e=r).exec(`
  ...
  `),(t=s=>{try{e.exec(s)}catch{}})("ALTER TABLE orders ADD COLUMN bank_id TEXT"),t("ALTER TABLE orders ADD COLUMN tracking_number TEXT"),t("ALTER TABLE installment_applications ADD COLUMN product_imageUrl TEXT"),function(e){var s;let t,i,o,T,r=s=>!!e.prepare("SELECT name FROM migrations WHERE name = ?").get(s),a=s=>e.prepare("INSERT OR IGNORE INTO migrations (name) VALUES (?)").run(s),c=s=>{try{e.exec(s)}catch{}};if(r("add_bevans_product_columns_v1")||(c("ALTER TABLE products ADD COLUMN slug TEXT NOT NULL DEFAULT ''"),c("ALTER TABLE products ADD COLUMN gender TEXT NOT NULL DEFAULT 'Unisex'"),c("ALTER TABLE products ADD COLUMN material TEXT NOT NULL DEFAULT ''"),c("ALTER TABLE products ADD COLUMN fit TEXT NOT NULL DEFAULT ''"),c("ALTER TABLE products ADD COLUMN newArrival INTEGER NOT NULL DEFAULT 0"),a("add_bevans_product_columns_v1")),r("create_product_variants_v1")||(e.exec(`
    ...
    `),a("create_product_variants_v1")),r("create_product_images_v1")||(e.exec(`
    ...
    `),a("create_product_images_v1")),!r("drop_solar_quotes_v1"))if(e.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='quotes'").get()){let s=e.prepare("SELECT COUNT(*) as c FROM quotes").get().c;s>0?console.warn(`[bevans] quotes table has ${s} row(s) — skipping drop. Manual review needed.`):(e.exec("DROP TABLE IF EXISTS quotes"),a("drop_solar_quotes_v1"))}else a("drop_solar_quotes_v1");r("seed_bevans_products_v1")||(0===e.prepare("SELECT COUNT(*) as c FROM products").get().c&&(s=e,t=new Date().toISOString(),i=s.prepare(`
