module.exports=[85148,(e,t,i)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},22734,(e,t,i)=>{t.exports=e.x("fs",()=>require("fs"))},70406,(e,t,i)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,i)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},20635,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24725,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},56704,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},59043,(e,t,i)=>{t.exports=e.x("next/dist/server/runtime-reacts.external.js",()=>require("next/dist/server/runtime-reacts.external.js"))},93695,(e,t,i)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},81111,(e,t,i)=>{t.exports=e.x("node:stream",()=>require("node:stream"))},84423,(e,t,i)=>{t.exports=e.x("nodemailer-9c35dd349a8aaa9f",()=>require("nodemailer-9c35dd349a8aaa9f"))},14747,(e,t,i)=>{t.exports=e.x("path",()=>require("path"))},62294,e=>{"use strict";var t=e.i(85148),i=e.i(14747),r=e.i(22734);let a=process.env.DATA_DIR??i.default.join(process.cwd(),"data"),o=i.default.join(a,"daisy.db"),s=[i.default.join(a,"products-backup.json"),i.default.join(process.cwd(),"data","products.json")],n=null;function p(){return n||((0,r.existsSync)(a)||(0,r.mkdirSync)(a,{recursive:!0}),(n=new t.default(o)).pragma("journal_mode = WAL"),n.pragma("foreign_keys = ON"),n.exec(`
  ...
  `),function(e){if(!e.prepare("SELECT name FROM migrations WHERE name = ?").get("json_import_gadgets_v1")){for(let t of s)if((0,r.existsSync)(t))try{let i=JSON.parse((0,r.readFileSync)(t,"utf-8"));if(Array.isArray(i)&&i.length>0){e.prepare("DELETE FROM products").run();let t=e.prepare(`
          INSERT OR REPLACE INTO products
            (id, name, price, category, description, imageUrl, inStock, featured, createdAt, updatedAt)
          VALUES
            (@id, @name, @price, @category, @description, @imageUrl, @inStock, @featured, @createdAt, @updatedAt)
        `);e.transaction(e=>{for(let i of e)t.run({...i,inStock:+!!i.inStock,featured:+!!i.featured})})(i);break}}catch{}e.prepare("INSERT OR IGNORE INTO migrations (name) VALUES (?)").run("json_import_gadgets_v1")}}(n),function(e){if(e.prepare("SELECT name FROM migrations WHERE name = ?").get("seed_products_v1"))return;if(e.prepare("SELECT COUNT(*) as c FROM products").get().c>0)return e.prepare("INSERT OR IGNORE INTO migrations (name) VALUES (?)").run("seed_products_v1");let t=new Date().toISOString(),i=e.prepare(`
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:${p};padding:28px 16px">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:16px;overflow:hidden;border:1px solid ${c}">
        ...
        <tr><td style="background:linear-gradient(90deg,${p},${s},${n},${s},${p});height:3px;font-size:0;line-height:0">&nbsp;</td></tr>
        ...
        <tr>
          <td style="background:${p};padding:24px 36px">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <img src="cid:${o}" alt="Daisy Gadgets Co." height="44" style="height:44px;width:auto;display:block;border:0" />
                </td>
                <td align="right">
                  <a href="${g}" style="color:${l};font-size:12px;text-decoration:none">daisygadgetsco.co.za</a>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="background:${p};padding:24px 36px;border-top:1px solid ${c}">
            <p style="margin:0 0 8px;color:${l};font-size:12px;text-align:center">
              ...
              &nbsp;\xb7&nbsp;
              <a href="${g}" style="color:${s};text-decoration:none;font-weight:600">daisygadgetsco.co.za</a>
            </p>
        ...
        <!-- Bottom gold bar -->
        <tr><td style="background:linear-gradient(90deg,${p},${s},${n},${s},${p});height:2px;font-size:0;line-height:0">&nbsp;</td></tr>

      </table>
    </td></tr>
  </table>
</body>
</html>`}function f(e){return`<p style="margin:0 0 3px;color:${l};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.12em">${e}</p>`}function y(){return`<div style="height:1px;background:${c};margin:24px 0"></div>`}function x(e,t,i=s,r=p){return`<a href="${t}" style="display:inline-block;background:${i};color:${r};font-weight:800;text-decoration:none;padding:13px 26px;border-radius:10px;font-size:14px;letter-spacing:0.02em">${e}</a>`}async function T(e){let t=e.items.map(e=>{let t=(parseFloat(String(e.price).replace(/[^0-9.]/g,""))*e.qty).toLocaleString("en-ZA"),i=e.imageUrl?`<img src="${e.imageUrl.startsWith("http")?e.imageUrl:g+e.imageUrl}" alt="${e.name}" width="56" height="56" style="width:56px;height:56px;object-fit:cover;border-radius:8px;display:block;border:1px solid ${c}" />`:`<div style="width:56px;height:56px;background:${d};border:1px solid ${c};border-radius:8px"></div>`;return`
    <tr>
    ...
    <!-- Ref pill -->
    <div style="background:${d};border:1px solid ${s}44;border-radius:10px;padding:14px 20px;margin-bottom:28px;display:flex;align-items:center">
    ...
    <div style="text-align:center">
      ${x("💬 Chat on WhatsApp",`https://wa.me/${m}?text=Hi%2C%20checking%20on%20order%20${e.ref}`,"#25D366","#fff")}
    </div>
  `);await h({to:e.email,subject:`Order Confirmed ✨ — ${e.ref} | Daisy Gadgets Co.`,html:i})}async function b(e){let t=u(`
    ${f("Payment Received")}
    ...
    ${x("Chat on WhatsApp",`https://wa.me/${m}?text=Hi%2C%20checking%20on%20order%20${e.ref}`,"#25D366","#fff")}
  `);await h({to:e.email,subject:`Payment Proof Received — ${e.ref} | Daisy Gadgets Co.`,html:t})}let S={approved:{pill:["Payment Approved","#22c55e"],icon:"🎊",title:"Your payment is confirmed!",body:"Great news — your payment has been verified and your order is now being packed and prepared for dispatch. We will notify you as soon as it ships.",cta:["💬 Chat on WhatsApp",`https://wa.me/${m}`]},rejected:{pill:["Action Required","#ef4444"],icon:"🔔",title:"Payment could not be verified",body:"Unfortunately we could not verify your payment. Please re-upload a clear, legible proof of payment or contact us directly to resolve this quickly.",cta:["📤 Upload New Proof",`${g}/checkout`]},shipped:{pill:["Shipped","#3b82f6"],icon:"📦",title:"Your order is on its way!",body:"Your order has been handed over to the courier and is heading your way. Delivery typically takes 2–5 business days within South Africa.",cta:["💬 Track via WhatsApp",`https://wa.me/${m}`]},delivered:{pill:["Delivered",s],icon:"🎁",title:"Your order has been delivered!",body:"We hope you love your new purchase! If you have any issues at all, please reach out immediately and we will make it right.",cta:["⭐ Leave a Review",`${g}/reviews`]}};async function E(e){let t=S[e.status];if(!t)return;let i=e.notes?`<div style="background:${d};border-left:3px solid ${s};border-radius:0 10px 10px 0;padding:14px 18px;margin:20px 0">
       ...
       </div>`:"",r={approved:`Payment Approved — ${e.ref} | Daisy Gadgets Co.`,rejected:`Action Required — ${e.ref} | Daisy Gadgets Co.`,shipped:`Your Order Has Shipped — ${e.ref} | Daisy Gadgets Co.`,delivered:`Order Delivered — ${e.ref} | Daisy Gadgets Co.`},a=u(`
    ...
    <p style="margin:0 0 4px;color:${l};font-size:13px">Order: <strong style="color:${s}">${e.ref}</strong></p>
    ${y()}
    <p style="margin:0 0 16px;color:#9ca3af;font-size:15px;line-height:1.7">Hi ${e.name.split(" ")[0]}, ${t.body}</p>
    ${i}
    ${t.cta?`<div style="margin-top:24px">${x(t.cta[0],t.cta[1])}&nbsp;&nbsp;${x("WhatsApp Us",`https://wa.me/${m}?text=Hi%2C%20re%20order%20${e.ref}`,"#25D366","#fff")}</div>`:""}
  `);await h({to:e.email,subject:r[e.status]??`Order Update — ${e.ref}`,html:a})}async function L(e){let t=u(`
    ${f("Your Quote is Ready")}
    ...
    <!-- Package card -->
    <div style="background:${d};border:1px solid ${s}44;border-radius:14px;padding:28px;margin-bottom:24px;text-align:center">
    ...
    <div style="background:${d};border:1px solid ${c};border-left:3px solid ${s};border-radius:0 12px 12px 0;padding:16px 20px;margin-bottom:28px">
    ...
    ${x("Accept Quote",`https://wa.me/${m}?text=Hi%2C%20I%20accept%20quote%20${e.ref}`,s,p)}
    &nbsp;&nbsp;
    ${x("Ask a Question",`https://wa.me/${m}?text=Hi%2C%20question%20about%20quote%20${e.ref}`,"#25D366","#fff")}
  `);await h({to:e.email,subject:`Your Quote — ${e.ref} | Daisy Gadgets Co.`,html:t})}async function w(e){let t=u(`
    ...
    <!-- Code card -->
    <div style="background:${p};border:1px solid ${s}55;border-radius:14px;padding:32px;text-align:center;margin-bottom:28px">
      ${f("Your Exclusive Discount Code")}
    ...
    ${x("🛍️ Shop Now",`${g}/shop`)}
    &nbsp;&nbsp;
    ${x("💬 Claim via WhatsApp",`https://wa.me/${m}?text=Hi%2C%20I%20have%20the%20discount%20code%20DAISY25`,"#25D366","#fff")}
  `);await h({to:e.email,subject:"✨ Your 25% Discount Code — Daisy Gadgets Co.",html:t})}e.s(["sendMail",0,h,"sendOrderConfirmation",0,T,"sendProofAcknowledgement",0,b,"sendQuoteReply",0,L,"sendStatusUpdate",0,E,"sendWelcomeEmail",0,w])}];
