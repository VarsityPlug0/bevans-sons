module.exports=[85148,(e,t,r)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},22734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},20635,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},59043,(e,t,r)=>{t.exports=e.x("next/dist/server/runtime-reacts.external.js",()=>require("next/dist/server/runtime-reacts.external.js"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},81111,(e,t,r)=>{t.exports=e.x("node:stream",()=>require("node:stream"))},84423,(e,t,r)=>{t.exports=e.x("nodemailer-9c35dd349a8aaa9f",()=>require("nodemailer-9c35dd349a8aaa9f"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},62294,e=>{"use strict";var t=e.i(85148),r=e.i(14747),i=e.i(22734);let a=process.env.DATA_DIR??r.default.join(process.cwd(),"data"),o=r.default.join(a,"daisy.db"),s=[r.default.join(a,"products-backup.json"),r.default.join(process.cwd(),"data","products.json")],n=null;function p(){return n||((0,i.existsSync)(a)||(0,i.mkdirSync)(a,{recursive:!0}),(n=new t.default(o)).pragma("journal_mode = WAL"),n.pragma("foreign_keys = ON"),n.exec(`
  ...
  `),function(e){if(!e.prepare("SELECT name FROM migrations WHERE name = ?").get("json_import_gadgets_v1")){for(let t of s)if((0,i.existsSync)(t))try{let r=JSON.parse((0,i.readFileSync)(t,"utf-8"));if(Array.isArray(r)&&r.length>0){e.prepare("DELETE FROM products").run();let t=e.prepare(`
          INSERT OR REPLACE INTO products
            (id, name, price, category, description, imageUrl, inStock, featured, createdAt, updatedAt)
          VALUES
            (@id, @name, @price, @category, @description, @imageUrl, @inStock, @featured, @createdAt, @updatedAt)
        `);e.transaction(e=>{for(let r of e)t.run({...r,inStock:+!!r.inStock,featured:+!!r.featured})})(r);break}}catch{}e.prepare("INSERT OR IGNORE INTO migrations (name) VALUES (?)").run("json_import_gadgets_v1")}}(n),function(e){if(e.prepare("SELECT name FROM migrations WHERE name = ?").get("seed_products_v1"))return;if(e.prepare("SELECT COUNT(*) as c FROM products").get().c>0)return e.prepare("INSERT OR IGNORE INTO migrations (name) VALUES (?)").run("seed_products_v1");let t=new Date().toISOString(),r=e.prepare(`
...
<body style="margin:0;padding:0;background:${a};font-family:'Helvetica Neue',Helvetica,Arial,sans-serif">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:${a};padding:28px 16px">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:16px;overflow:hidden;border:1px solid ${s}">

        <!-- Gold shimmer top bar -->
        <tr><td style="background:linear-gradient(90deg,${a},${r},${i},${r},${a});height:3px;font-size:0;line-height:0">&nbsp;</td></tr>

        <!-- Header -->
        <tr>
          <td style="background:${a};padding:24px 36px">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <img src="${d}/logo.jpg" alt="Daisy Gadgets Co." height="44" style="height:44px;width:auto;display:block;border:0" />
                </td>
                <td align="right">
                  <a href="${d}" style="color:${n};font-size:12px;text-decoration:none">daisygadgetsco.co.za</a>
                </td>
              </tr>
            </table>
          </td>
        ...
        <!-- Body -->
        <tr>
          <td style="background:#111111;padding:36px 36px 32px;border-top:1px solid ${s}">
            ${e}
          </td>
        </tr>
        ...
        <!-- Footer -->
        <tr>
          <td style="background:${a};padding:24px 36px;border-top:1px solid ${s}">
            <p style="margin:0 0 8px;color:${n};font-size:12px;text-align:center">
              Questions? &nbsp;
              <a href="https://wa.me/${p}" style="color:${r};text-decoration:none;font-weight:600">WhatsApp +27 84 896 1782</a>
              &nbsp;\xb7&nbsp;
              <a href="${d}" style="color:${r};text-decoration:none;font-weight:600">daisygadgetsco.co.za</a>
            </p>
        ...
        <!-- Bottom gold bar -->
        <tr><td style="background:linear-gradient(90deg,${a},${r},${i},${r},${a});height:2px;font-size:0;line-height:0">&nbsp;</td></tr>

      </table>
    </td></tr>
  </table>
</body>
</html>`}function m(e){return`<p style="margin:0 0 3px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.12em">${e}</p>`}function g(){return`<div style="height:1px;background:${s};margin:24px 0"></div>`}function h(e,t,i=r,o=a){return`<a href="${t}" style="display:inline-block;background:${i};color:${o};font-weight:800;text-decoration:none;padding:13px 26px;border-radius:10px;font-size:14px;letter-spacing:0.02em">${e}</a>`}async function u(e){let t=e.items.map(e=>{let t=(parseFloat(String(e.price).replace(/[^0-9.]/g,""))*e.qty).toLocaleString("en-ZA"),i=e.imageUrl?`<img src="${e.imageUrl.startsWith("http")?e.imageUrl:d+e.imageUrl}" alt="${e.name}" width="56" height="56" style="width:56px;height:56px;object-fit:cover;border-radius:8px;display:block;border:1px solid ${s}" />`:`<div style="width:56px;height:56px;background:${o};border:1px solid ${s};border-radius:8px"></div>`;return`
    <tr>
      <td style="padding:12px 0;border-bottom:1px solid ${s};width:68px;vertical-align:middle">${i}</td>
      <td style="padding:12px 12px;border-bottom:1px solid ${s};vertical-align:middle">
      ...
      <td style="padding:12px 0;border-bottom:1px solid ${s};text-align:right;vertical-align:middle">
        <span style="color:${r};font-size:14px;font-weight:700">R ${t}</span>
      </td>
    </tr>`}).join(""),i=l(`
    ...
    <!-- Ref pill -->
    <div style="background:${o};border:1px solid ${r}44;border-radius:10px;padding:14px 20px;margin-bottom:28px;display:flex;align-items:center">
      <table width="100%" cellpadding="0" cellspacing="0"><tr>
        <td style="color:${n};font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Order Reference</td>
        <td style="text-align:right;color:${r};font-size:18px;font-weight:900;letter-spacing:0.08em;font-family:monospace">${e.ref}</td>
      </tr></table>
    </div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin:12px 0 28px">
      <tr>
        <td style="padding:6px 0;color:${n};font-size:13px">Subtotal</td>
        <td style="padding:6px 0;text-align:right;color:#d1d5db;font-size:13px">R ${e.total.toLocaleString("en-ZA")}</td>
      </tr>
      <tr>
        <td style="padding:6px 0;color:${n};font-size:13px">Shipping</td>
        <td style="padding:6px 0;text-align:right;color:#22c55e;font-size:13px;font-weight:700">Free</td>
      </tr>
      <tr>
        <td style="padding:10px 0 0;color:#e5e7eb;font-size:16px;font-weight:800;border-top:1px solid ${s}">Total</td>
        <td style="padding:10px 0 0;text-align:right;color:${r};font-size:20px;font-weight:900;border-top:1px solid ${s}">R ${e.total.toLocaleString("en-ZA")}</td>
      </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px">
      <tr>
        <td width="50%" style="padding:0 8px 0 0;vertical-align:top">
          <div style="background:${o};border:1px solid ${s};border-radius:10px;padding:16px 18px;margin-bottom:12px">
            <p style="margin:0 0 6px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Shipping Address</p>
            <p style="margin:0;color:#d1d5db;font-size:13px;line-height:1.6">${e.name}<br>${e.address||"—"}</p>
          </div>
          <div style="background:${o};border:1px solid ${s};border-radius:10px;padding:16px 18px">
            <p style="margin:0 0 6px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Billing Address</p>
            <p style="margin:0;color:#d1d5db;font-size:13px;line-height:1.6">${e.name}<br>${e.address||"—"}</p>
          </div>
        </td>
        <td width="50%" style="padding:0 0 0 8px;vertical-align:top">
          <div style="background:${o};border:1px solid ${s};border-radius:10px;padding:16px 18px;margin-bottom:12px">
            <p style="margin:0 0 6px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Shipping Method</p>
            <p style="margin:0;color:#d1d5db;font-size:13px">📦 Standard Delivery<br><span style="color:${n};font-size:12px">2–5 business days</span></p>
          </div>
          <div style="background:${o};border:1px solid ${s};border-radius:10px;padding:16px 18px">
            <p style="margin:0 0 6px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Payment Method</p>
    ...
    <div style="text-align:center">
      ${h("💬 Chat on WhatsApp",`https://wa.me/${p}?text=Hi%2C%20checking%20on%20order%20${e.ref}`,"#25D366","#fff")}
    </div>
  `);await c({to:e.email,subject:`Order Confirmed ✨ — ${e.ref} | Daisy Gadgets Co.`,html:i})}async function f(e){let t=l(`
    ${m("Payment Received")}
    ...
    <p style="margin:0 0 24px;color:#9ca3af;font-size:15px;line-height:1.6">
      Hi ${e.name.split(" ")[0]}, we received your proof of payment for order <strong style="color:${r}">${e.ref}</strong>.
    </p>

    <div style="background:${o};border:1px solid #22c55e44;border-left:3px solid #22c55e;border-radius:0 12px 12px 0;padding:18px 20px;margin-bottom:28px">
    ...
    ${h("Chat on WhatsApp",`https://wa.me/${p}?text=Hi%2C%20checking%20on%20order%20${e.ref}`,"#25D366","#fff")}
  `);await c({to:e.email,subject:`Payment Proof Received — ${e.ref} | Daisy Gadgets Co.`,html:t})}let y={approved:{pill:["Payment Approved","#22c55e"],icon:"🎊",title:"Your payment is confirmed!",body:"Great news — your payment has been verified and your order is now being packed and prepared for dispatch. We will notify you as soon as it ships.",cta:["💬 Chat on WhatsApp",`https://wa.me/${p}`]},rejected:{pill:["Action Required","#ef4444"],icon:"🔔",title:"Payment could not be verified",body:"Unfortunately we could not verify your payment. Please re-upload a clear, legible proof of payment or contact us directly to resolve this quickly.",cta:["📤 Upload New Proof",`${d}/checkout`]},shipped:{pill:["Shipped","#3b82f6"],icon:"📦",title:"Your order is on its way!",body:"Your order has been handed over to the courier and is heading your way. Delivery typically takes 2–5 business days within South Africa.",cta:["💬 Track via WhatsApp",`https://wa.me/${p}`]},delivered:{pill:["Delivered",r],icon:"🎁",title:"Your order has been delivered!",body:"We hope you love your new purchase! If you have any issues at all, please reach out immediately and we will make it right.",cta:["⭐ Leave a Review",`${d}/reviews`]}};async function x(e){let t=y[e.status];if(!t)return;let i=e.notes?`<div style="background:${o};border-left:3px solid ${r};border-radius:0 10px 10px 0;padding:14px 18px;margin:20px 0">
        <p style="margin:0 0 4px;color:${n};font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em">Note from our team</p>
        <p style="margin:0;color:#d1d5db;font-size:14px;font-style:italic;line-height:1.6">"${e.notes}"</p>
       </div>`:"",a={approved:`Payment Approved — ${e.ref} | Daisy Gadgets Co.`,rejected:`Action Required — ${e.ref} | Daisy Gadgets Co.`,shipped:`Your Order Has Shipped — ${e.ref} | Daisy Gadgets Co.`,delivered:`Order Delivered — ${e.ref} | Daisy Gadgets Co.`},s=l(`
    ...
    <p style="margin:0 0 4px;color:${n};font-size:13px">Order: <strong style="color:${r}">${e.ref}</strong></p>
    ${g()}
    <p style="margin:0 0 16px;color:#9ca3af;font-size:15px;line-height:1.7">Hi ${e.name.split(" ")[0]}, ${t.body}</p>
    ${i}
    ${t.cta?`<div style="margin-top:24px">${h(t.cta[0],t.cta[1])}&nbsp;&nbsp;${h("WhatsApp Us",`https://wa.me/${p}?text=Hi%2C%20re%20order%20${e.ref}`,"#25D366","#fff")}</div>`:""}
  `);await c({to:e.email,subject:a[e.status]??`Order Update — ${e.ref}`,html:s})}async function T(e){let t=l(`
    ${m("Your Quote is Ready")}
    <h1 style="margin:6px 0 6px;color:#f9fafb;font-size:28px;font-weight:900">Hi ${e.name.split(" ")[0]}, here is your quote</h1>
    <p style="margin:0 0 28px;color:${n};font-size:13px">Reference: <strong style="color:#e5e7eb">${e.ref}</strong></p>

    <!-- Package card -->
    <div style="background:${o};border:1px solid ${r}44;border-radius:14px;padding:28px;margin-bottom:24px;text-align:center">
      ${m("Recommended Package")}
      <p style="margin:8px 0 20px;color:#f9fafb;font-size:22px;font-weight:900">${e.package}</p>
      <div style="height:1px;background:${s};margin:0 0 20px"></div>
      ${m("Estimated Price")}
      <p style="margin:8px 0 0;color:${r};font-size:34px;font-weight:900;letter-spacing:0.02em">${e.price}</p>
    </div>

    ${e.message?`
    <p style="margin:0 0 10px;color:#e5e7eb;font-size:15px;font-weight:700">Message from our team</p>
    <div style="background:${o};border:1px solid ${s};border-left:3px solid ${r};border-radius:0 12px 12px 0;padding:16px 20px;margin-bottom:28px">
    ...
    ${h("Accept Quote",`https://wa.me/${p}?text=Hi%2C%20I%20accept%20quote%20${e.ref}`,r,a)}
    &nbsp;&nbsp;
    ${h("Ask a Question",`https://wa.me/${p}?text=Hi%2C%20question%20about%20quote%20${e.ref}`,"#25D366","#fff")}
  `);await c({to:e.email,subject:`Your Quote — ${e.ref} | Daisy Gadgets Co.`,html:t})}async function b(e){let t=l(`
    ...
    <!-- Code card -->
    <div style="background:${a};border:1px solid ${r}55;border-radius:14px;padding:32px;text-align:center;margin-bottom:28px">
      ${m("Your Exclusive Discount Code")}
      <p style="margin:12px 0;color:${r};font-size:40px;font-weight:900;letter-spacing:0.15em;font-family:monospace">DAISY25</p>
      <div style="height:1px;background:${s};margin:16px 0"></div>
      <p style="margin:0;color:${n};font-size:13px;line-height:1.6">💎 25% off your first order — mention this code on WhatsApp<br>when placing your order. Valid for all products.</p>
    </div>
    ...
    ${h("🛍️ Shop Now",`${d}/shop`)}
    &nbsp;&nbsp;
    ${h("💬 Claim via WhatsApp",`https://wa.me/${p}?text=Hi%2C%20I%20have%20the%20discount%20code%20DAISY25`,"#25D366","#fff")}
  `);await c({to:e.email,subject:"✨ Your 25% Discount Code — Daisy Gadgets Co.",html:t})}e.s(["sendMail",0,c,"sendOrderConfirmation",0,u,"sendProofAcknowledgement",0,f,"sendQuoteReply",0,T,"sendStatusUpdate",0,x,"sendWelcomeEmail",0,b])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__14-kfrm._.js.map