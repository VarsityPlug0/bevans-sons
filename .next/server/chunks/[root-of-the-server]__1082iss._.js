module.exports=[85148,(e,t,r)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},22734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},20635,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},59043,(e,t,r)=>{t.exports=e.x("next/dist/server/runtime-reacts.external.js",()=>require("next/dist/server/runtime-reacts.external.js"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},81111,(e,t,r)=>{t.exports=e.x("node:stream",()=>require("node:stream"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},10423,e=>{"use strict";var t=e.i(89171),r=e.i(68105),a=e.i(39258);async function n(e,{params:s}){if(!await (0,r.isAuthenticated)())return t.NextResponse.json({error:"Unauthorized"},{status:401});let{productId:i}=await s;if("all"===i)return t.NextResponse.json((0,a.listAllSettings)());let T=(0,a.getSettings)(i);return t.NextResponse.json(T??null)}async function s(e,{params:n}){if(!await (0,r.isAuthenticated)())return t.NextResponse.json({error:"Unauthorized"},{status:401});let{productId:i}=await n,{min_deposit_pct:T,eligible_terms:o,monthly_rate:E,admin_fee:d,active:l}=await e.json();if(!Array.isArray(o)||0===o.length)return t.NextResponse.json({error:"eligible_terms must be a non-empty array"},{status:400});let p=(0,a.upsertSettings)({product_id:i,min_deposit_pct:Number(T??10),eligible_terms:o.map(Number),monthly_rate:Number(E??0),admin_fee:Number(d??0),active:!1!==l});return t.NextResponse.json(p)}e.s(["GET",0,n,"POST",0,s])},22540,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),n=e.i(59756),s=e.i(61916),i=e.i(74677),T=e.i(69741),o=e.i(16795),E=e.i(87718),d=e.i(95169),l=e.i(47587),p=e.i(66012),c=e.i(70101),u=e.i(26937),N=e.i(10372),L=e.i(93695);e.i(52474);var m=e.i(220);let A=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/admin/installments/settings/[productId]/route",pathname:"/api/admin/installments/settings/[productId]",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/admin/installments/settings/[productId]/route.ts",nextConfigOutput:"",userland:()=>e.r(10423),...{}}),{workAsyncStorage:R,workUnitAsyncStorage:O,serverHooks:_}=A;async function U(e,t,a){a.requestMeta&&(0,n.setRequestMeta)(e,a.requestMeta),A.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let R="/api/admin/installments/settings/[productId]/route";R=R.replace(/\/index$/,"")||"/";let O=await A.prepare(e,t,{srcPage:R,multiZoneDraftMode:!1});if(!O)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:_,deploymentId:U,params:g,nextConfig:X,parsedUrl:h,isDraftMode:S,prerenderManifest:I,routerServerContext:v,isOnDemandRevalidate:x,revalidateOnlyGenerated:f,resolvedPathname:D,clientReferenceManifest:C,serverActionsManifest:y}=O,b=(0,T.normalizeAppPath)(R),F=!!(I.dynamicRoutes[b]||I.routes[D]),w=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,h,!1):t.end("This page could not be found"),null);if(F&&!S){let e=!!I.routes[D],t=I.dynamicRoutes[b];if(t&&!1===t.fallback&&!e){if(X.adapterPath)return await w();throw new L.NoFallbackError}}let M=null;!F||A.isDev||S||(M="/index"===(M=D)?"/":M);let P=!0===A.isDev||!F,k=F&&!P;y&&C&&(0,i.setManifestsSingleton)({page:R,clientReferenceManifest:C,serverActionsManifest:y});let q=e.method||"GET",B=(0,s.getTracer)(),Y=B.getActiveScopeSpan(),j=!!(null==v?void 0:v.isWrappedByNextServer),H=!!(0,n.getRequestMeta)(e,"minimalMode"),K=(0,n.getRequestMeta)(e,"incrementalCache")||await A.getIncrementalCache(e,X,I,H);null==K||K.resetRequestCache(),globalThis.__incrementalCache=K;let G={params:g,previewProps:I.preview,renderOpts:{experimental:{authInterrupts:!!X.experimental.authInterrupts,useCacheTimeout:X.experimental.useCacheTimeout},cacheComponents:!!X.cacheComponents,validationLevel:X.experimental.instantInsights.validationLevel,supportsDynamicResponse:P,incrementalCache:K,hmrRefreshHash:(0,n.getRequestMeta)(e,"hmrRefreshHash"),cacheLifeProfiles:X.cacheLife,staticPageGenerationTimeout:X.staticPageGenerationTimeout,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>A.onRequestError(e,t,a,n,v)},sharedContext:{buildId:_,deploymentId:U}},W=new o.NodeNextRequest(e),J=new o.NodeNextResponse(t),V=E.NextRequestAdapter.fromNodeNextRequest(W,(0,E.signalFromNodeResponse)(t)),$=async({previousCacheEntry:r})=>{try{if(!H&&x&&f&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await A.handle(V,G);e.fetchMetrics=G.renderOpts.fetchMetrics;let s=G.renderOpts.pendingWaitUntil;s&&a.waitUntil&&(a.waitUntil(s),s=void 0);let i=G.renderOpts.collectedTags;if(!F)return await (0,p.sendResponse)(W,J,n,s),null;{let e=await n.blob(),t=(0,c.toNodeOutgoingHttpHeaders)(n.headers);i&&(t[N.NEXT_CACHE_TAGS_HEADER]=i),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==G.renderOpts.collectedRevalidate&&!(G.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&G.renderOpts.collectedRevalidate,a=void 0===G.renderOpts.collectedExpire||G.renderOpts.collectedExpire>=N.INFINITE_CACHE?!1!==r&&r>0?X.expireTime:void 0:G.renderOpts.collectedExpire;return{value:{kind:m.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await A.onRequestError(e,t,{routerKind:"App Router",routePath:R,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:x})},!1,v),t}},Q=async(n,i)=>{try{var T,o;let n=await A.handleResponse({req:e,nextConfig:X,cacheKey:M,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:x,revalidateOnlyGenerated:f,responseGenerator:$,waitUntil:a.waitUntil,isMinimalMode:H});if(!F)return;if((null==n||null==(T=n.value)?void 0:T.kind)!==m.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==n||null==(o=n.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});H||t.setHeader("x-nextjs-cache",x?"REVALIDATED":n.isMiss?"MISS":n.isStale?"STALE":"HIT"),S&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let s=(0,c.fromNodeOutgoingHttpHeaders)(n.value.headers);H&&F||s.delete(N.NEXT_CACHE_TAGS_HEADER),!n.cacheControl||t.getHeader("Cache-Control")||s.get("Cache-Control")||s.set("Cache-Control",(0,u.getCacheControlHeader)(n.cacheControl)),await (0,p.sendResponse)(W,J,new Response(n.value.body,{headers:s,status:n.value.status||200}));return}catch(t){if(t instanceof L.NoFallbackError||await A.onRequestError(e,t,{routerKind:"App Router",routePath:b,routeType:"route",revalidateReason:(0,l.getRevalidateReason)({isStaticGeneration:k,isOnDemandRevalidate:x})},!1,v),F)throw t;await (0,p.sendResponse)(W,J,new Response(null,{status:500}));return}finally{(()=>{if(!n)return;let e=t.statusCode;n.setAttributes({"http.status_code":e,"next.rsc":!1}),e&&e>=500&&(n.setStatus({code:s.SpanStatusCode.ERROR}),n.setAttribute("error.type",e.toString()));let r=B.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route")||b,T=`${q} ${a}`;n.setAttributes({"next.route":a,"http.route":a,"next.span_name":T}),n.updateName(T),i&&i!==n&&(i.setAttribute("http.route",a),i.updateName(T))})()}};if(j&&Y)await Q(Y,void 0);else{let t=B.getActiveScopeSpan();await B.withPropagatedContext(e.headers,()=>B.trace(d.BaseServerSpan.handleRequest,{spanName:`${q} ${R}`,kind:s.SpanKind.SERVER,attributes:{"http.method":q,"http.target":e.url}},e=>Q(e,t)),void 0,!j)}}e.s(["handler",0,U,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:R,workUnitAsyncStorage:O})},"routeModule",0,A,"serverHooks",0,_,"workAsyncStorage",0,R,"workUnitAsyncStorage",0,O])},62294,e=>{"use strict";var t=e.i(85148),r=e.i(14747),a=e.i(22734);let n=process.env.DATA_DIR??r.default.join(process.cwd(),"data"),s=r.default.join(n,"bevans.db"),i=null;function T(){var e;let r;return i||((0,a.existsSync)(n)||(0,a.mkdirSync)(n,{recursive:!0}),(i=new t.default(s)).pragma("journal_mode = WAL"),i.pragma("foreign_keys = ON"),(e=i).exec(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1082iss._.js.map