      ...
      <div className="grid md:grid-cols-5 gap-10">
        ...
        <div className="md:col-span-2 space-y-5">
          {[
            {
              ...
              content: <span className="text-white font-semibold">Coming soon</span>,
            ...
            },
            {
              ...
              content: <span className="text-white font-semibold">South Africa — Online Only</span>,
          ...
          <div className="bg-[#111111] border border-[#1F1F1F] rounded-2xl p-5">
            <p className="text-white font-bold text-sm mb-2">Get In Touch</p>
            <p className="text-gray-400 text-sm leading-relaxed">
              Fill in the form and we&apos;ll get back to you within 24 hours. WhatsApp and email contact details coming soon.
            </p>
          </div>
        </div>
