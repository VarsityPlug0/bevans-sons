    ...
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-20">
      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        {[
          ...
          {
            title: "8. Contact",
            body: "Warranty claims: daisygadgetsco@gmail.com | WhatsApp: +27 84 896 1782",
          },
        ].map(({ title, body }) => (
          <div key={title}>
