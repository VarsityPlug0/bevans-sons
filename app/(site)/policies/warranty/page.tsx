    ...
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-20">
      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        {[
          ...
          {
            title: "8. Contact",
            body: "Warranty claims: MkhabeleEnterprise@gmail.com | WhatsApp: +27 72 481 6274",
          },
        ].map(({ title, body }) => (
          <div key={title}>
