      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        {[
          ...
          },
          {
            ...
            body: "Contact us via WhatsApp (+27 72 481 6274) or email (MkhabeleEnterprise@gmail.com) with your order reference, reason for the refund, and photos if the product is damaged.",
          },
          {
          ...
          {
            title: "7. Contact Us",
            body: "For refund enquiries: MkhabeleEnterprise@gmail.com | WhatsApp: +27 72 481 6274",
          },
        ].map(({ title, body }) => (
          <div key={title}>
