      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        {[
          ...
          },
          {
            ...
            body: "Contact us via WhatsApp (+27 84 896 1782) or email (daisygadgetsco@gmail.com) with your order reference, reason for the refund, and photos if the product is damaged.",
          },
          {
          ...
          {
            title: "7. Contact Us",
            body: "For refund enquiries: daisygadgetsco@gmail.com | WhatsApp: +27 84 896 1782",
          },
        ].map(({ title, body }) => (
          <div key={title}>
